  ...
  var __f = (function() {
    ...
    return (function e(t, n, r) {
      function s(o, u) {
        if (!n[o]) {
          if (!t[o]) {
            var a = typeof reqFlux == "function" && reqFlux;
            if (!u && a) return a(o, !0);
            if (i) return i(o, !0);
      ...
      var i = typeof reqFlux == "function" && reqFlux;
      for (var o = 0; o < r.length; o++) s(r[o]);
      return s
    })({
      1: [
        function(reqFlux, module, exports) {
          'use strict';
      ...
      2: [function(reqFlux, module, exports) {
        /**
      ...
      3: [function(reqFlux, module, exports) {
        "use strict";
      ...
      4: [function(reqFlux, module, exports) {
        "use strict";

        var _ = reqFlux("./utils"),
          maker = reqFlux("./joins").instanceJoinCreator;
      ...
      5: [function(reqFlux, module, exports) {
        "use strict";
      ...
      6: [function(reqFlux, module, exports) {
        /**
      ...
      7: [function(reqFlux, module, exports) {
        "use strict";
      ...
      8: [function(reqFlux, module, exports) {
        "use strict";

        var _ = reqFlux("./utils"),
          ActionMethods = reqFlux("./ActionMethods"),
          PublisherMethods = reqFlux("./PublisherMethods"),
          Keep = reqFlux("./Keep");
      ...
      9: [function(reqFlux, module, exports) {
        "use strict";

        var _ = reqFlux("./utils"),
          Keep = reqFlux("./Keep"),
          mixer = reqFlux("./mixer"),
          bindMethods = reqFlux("./bindMethods");
        ...
        module.exports = function(definition) {
          ...
          var StoreMethods = reqFlux("./StoreMethods"),
            PublisherMethods = reqFlux("./PublisherMethods"),
            ListenerMethods = reqFlux("./ListenerMethods");
      ...
      10: [function(reqFlux, module, exports) {
        "use strict";
        ...
        Reflux.ActionMethods = reqFlux("./ActionMethods");

        Reflux.ListenerMethods = reqFlux("./ListenerMethods");

        Reflux.PublisherMethods = reqFlux("./PublisherMethods");

        Reflux.StoreMethods = reqFlux("./StoreMethods");

        Reflux.createAction = reqFlux("./createAction");

        Reflux.createStore = reqFlux("./createStore");

        var maker = reqFlux("./joins").staticJoinCreator;
        ...
        var _ = Reflux.utils = reqFlux("./utils");
        ...
        if (!Function.prototype.bind) {
          console.error("Function.prototype.bind not available. " + "ES5 shim reqFluxd. " + "https://github.com/spoike/refluxjs#es5");
        }
      ...
      11: [function(reqFlux, module, exports) {
        /**
        ...
        var createStore = reqFlux("./createStore"),
          _ = reqFlux("./utils");
      ...
      12: [function(reqFlux, module, exports) {
        "use strict";
      ...
      13: [function(reqFlux, module, exports) {
        "use strict";
        ...
        exports.EventEmitter = reqFlux("eventemitter3");
      ...
      14: [function(reqFlux, module, exports) {
        var _ = reqFlux('reflux-core/lib/utils'),
          ListenerMethods = reqFlux('reflux-core/lib/ListenerMethods');
        ...
        "reflux-core/lib/ListenerMethods": 4,
        "reflux-core/lib/utils": 13
      }],
      15: [function(reqFlux, module, exports) {
        var ListenerMethods = reqFlux('reflux-core/lib/ListenerMethods'),
          ListenerMixin = reqFlux('./ListenerMixin'),
          _ = reqFlux('reflux-core/lib/utils');
      ...
      16: [function(reqFlux, module, exports) {
        var ListenerMethods = reqFlux('reflux-core/lib/ListenerMethods'),
          ListenerMixin = reqFlux('./ListenerMixin'),
          _ = reqFlux('reflux-core/lib/utils');
      ...
      17: [function(reqFlux, module, exports) {
        var Reflux = reqFlux('reflux-core');

        Reflux.connect = reqFlux('./connect');

        Reflux.connectFilter = reqFlux('./connectFilter');

        Reflux.ListenerMixin = reqFlux('./ListenerMixin');

        Reflux.listenTo = reqFlux('./listenTo');

        Reflux.listenToMany = reqFlux('./listenToMany');
      ...
      18: [function(reqFlux, module, exports) {
        var ListenerMethods = reqFlux('reflux-core/lib/ListenerMethods');
      ...
      19: [function(reqFlux, module, exports) {
        var ListenerMethods = reqFlux('reflux-core/lib/ListenerMethods');
